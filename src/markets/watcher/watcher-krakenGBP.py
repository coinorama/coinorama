#!/usr/bin/python
#
# Coinorama/coinref: watch and store raw Kraken GBP market info
#
...
# Watcher class
class KrakenGBPWatcher (coinwatcher.CoinWatcher) :
    ...
    def fetchData ( self ):
        ...
        ed = coinwatcher.CoinWatcher.fetchData ( self, httplib.HTTPSConnection, 'api.kraken.com', '/0/public/Depth?pair=XXBTZGBP', trades )
        return ed

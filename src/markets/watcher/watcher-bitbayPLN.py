#!/usr/bin/python
#
# Coinorama/coinref: watch and store raw Bitbay PLN market info
#
...
# Watcher class
class BitbayPLNWatcher (coinwatcher.CoinWatcher) :
    ...
    def fetchData ( self ):
        ...
        ed = coinwatcher.CoinWatcher.fetchData ( self, httplib.HTTPSConnection, 'market.bitbay.pl', '/API/Public/BTCPLN/orderbook.json', trades )
        return ed

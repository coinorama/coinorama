#!/usr/bin/python
#
# Coinorama/coinref: watch and store raw QuadrigaCX CAD market info
#
...
# Watcher class
class QuadrigaCXCADWatcher (coinwatcher.CoinWatcher) :
    ...
    def fetchData ( self ):
        ...
        trades = '/v2/transactions' # default: ?time=hour
        ed = coinwatcher.CoinWatcher.fetchData ( self, httplib.HTTPSConnection, 'api.quadrigacx.com', '/v2/order_book', trades )
        return ed
...
if __name__ == "__main__":
    coinwatcher.main ( 'QuadrigaCX-CAD', 'quadrigacxCAD', QuadrigaCXCADWatcher )
